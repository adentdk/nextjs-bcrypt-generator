...
interface IHashFormProps {
  onSubmit: () => void
  control: any
  hashTextValue: string
  loading: boolean
  error: string | null
}
...
export default function HashForm({ onSubmit, error, control, hashTextValue, loading }: IHashFormProps) {
  ...
  const buttonCopyDisabled = loading || hashTextValue === ''
      ...
      <div className='grid gap-3 grid-cols-1 sm:grid-cols-3 my-4'>
        <ControlledTextInput
          ...
          textInputProps={{
            ...
            label: 'Plain Text to hash',
            placeholder: 'Plain Text to hash',
            id: 'plain-text-to-hash',
            type: 'text',
            fullWidth: true,
            autoComplete: 'off',
            autoCapitalize: 'off'
